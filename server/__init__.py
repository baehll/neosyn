...
def create_app() -> Flask:
    ...
    CORS(app, resources={
            r"/api/*": {"origins": ["https://unaite.ai", "https://quiet-mountain-69143-51eb8184b186.herokuapp.com/"]},
            r"/auth/*": {"origins": ["https://unaite.ai", "https://quiet-mountain-69143-51eb8184b186.herokuapp.com/"]}
        })
    csp = {
        'default-src': [
            '\'self\'', 
