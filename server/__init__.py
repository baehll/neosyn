...
def create_app() -> Flask:
    ...
    cors_domains = [r"https://unaite.ai/*", r"http://unaite.ai/*", r"https://quiet-mountain-69143-51eb8184b186.herokuapp.com/*", r"http://quiet-mountain-69143-51eb8184b186.herokuapp.com/*"]
    CORS(app, resources={
