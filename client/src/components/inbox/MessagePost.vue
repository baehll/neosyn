  ...
  <div class="bg-darkgray shrink-0 h-1/2 overflow-hidden rounded-xl flex flex-col justify-between">
    <div class="flex flex-col">
      ...
      <div class="px-4 py-2 text-white">
        <p>ARE YOU READY? 🤤Nur noch 7 TAGE und eure creamy dreams werden wahr 🫠Am Dienstag launchen wir exklusiv in
    ...
    <div class="h-8 shrink-0 bg-darkgray-80 flex justify-center items-center">
